...
(function () {
  ...
  class Config {
    ...
    _mergeConfigObj(config, element) {
      ...
      return _objectSpread2(_objectSpread2(_objectSpread2(_objectSpread2({}, this.constructor.Default), typeof jsonConfig === 'object' ? jsonConfig : {}), isElement(element) ? Manipulator.getDataAttributes(element) : {}), typeof config === 'object' ? config : {});
    }
  ...
  if ('serviceWorker' in navigator) {
    ...
    if (register) {
      const swUrl = "".concat(baseUrl, "/sw.min.js");
